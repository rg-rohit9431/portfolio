...
const Footer = () => {
    return (
        <div className='bg-[#232323] w-[100%] h-[30vh] max-h-fit p-[2rem] flex md:flex-row flex-col items-center justify-around xl:justify-center'>
            ...
            <div className='flex items-center w-[50%] lg:w-fit justify-between md:justify-start gap-[1rem] md:gap-[3rem]  text-[#c0c0c0] mt-[1rem] '>
                <NavLink to='https://www.instagram.com/rg_rohit9431' target='_blank'><FaInstagram className="text-[1.9rem] text-red-600" /></NavLink>
                <NavLink to='https://www.linkedin.com/in/rohit-gupta-40a631232/' target='_blank' ><FaLinkedin className="text-[1.9rem] text-blue-600" /></NavLink>
