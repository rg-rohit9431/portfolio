    ...
    return (
        ...
        <div className='h-[100vh] gap-[1rem] lg:gap-[.5rem] w-[100%] flex flex-col sm:flex-row  sm:justify-around  md:flex-col justify-center  lg:justify-around items-center xl:justify-center xl:gap-[2rem]'>
            ...
            <div className='projectImg  relative overflow-x-hidden w-[100%] max-w-[250px] h-fit'>
                ...
                <img src={item?.img} alt="Img" className='mb-[1rem] w-[100%] aspect-auto'></img>
                <Link to={item?.link} target='_blank' className='w-full flex justify-between items-center rounded-md p-[.6rem] border-2 border-black shadow-md bg-[white] mt-2 text-[1.3rem] font-[600] text-[#232323] '>
                    <p>See Project...</p>
